...
from data_trials.entity.config_entity import DataValidationConfig
...
from data_trials.entity.artifact_entity import DataValidationArtifact
...
class DataValidation(NewsDataSchema):
    ...
    def read_data(self) -> DataFrame:
        try:
            ...
            # ).limit(30) #here limit is set to 500 records only as Google Translator has limit for free usage
            dataframe: pandas_dataframe = pd.read_parquet(
                self.data_ingestion_artifact.feature_store_file_path ,engine='pyarrow')
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        try:
            ...
            dataframe.to_parquet(accepted_file_path)
