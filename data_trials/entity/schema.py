...
class NewsDataSchema:
    ...
    def __init__(self):
        ...
        self.col_lead_paragraph: str = "lead_paragraph"
        ...
        try:
            schema = StructType([
               ...
               # StructField(self.col_zip_code, StringType()),
                StructField(self.col_lead_paragraph, StringType()),
    ...
    def required_columns(self) -> List[str]:
        ...
        features = [self.col_lead_paragraph]
        return features
